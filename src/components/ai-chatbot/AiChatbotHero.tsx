...
const AiChatbotHero = () => {
  ...
  <div className="text-center max-w-full w-full relative">
    ...
    <div className="absolute bottom-[80px] flex flex-col w-full max-tab-lg:mt-[50px] max-tab-md:relative max-tab-md:bottom-0 max-tab-lg:px-4 z-[2]">
      <h1 className="text-[50px] lg:max-w-[1000px] lg:w-full lg:mx-auto font-bold text-white leading-[60px] max-tab-md:text-black max-mob-lg:text-2xl max-des-3xl:text-[40px] max-mob-lg:leading-[1.2] max-des-3xl:leading-[40px]">
