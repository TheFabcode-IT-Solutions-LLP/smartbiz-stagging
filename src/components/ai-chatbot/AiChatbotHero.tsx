  ...
  return (
    ...
    <section className="pb-[50px] relative bg-primary-100">
      <div className="text-center max-w-full w-full relative">
        ...
        <div data-aos="fade-up" className="absolute bottom-[80px] flex flex-col w-full max-tab-lg:mt-[50px] max-tab-md:relative max-tab-md:bottom-0 max-tab-lg:px-4 z-[2]">
