    ...
    <div className="py-[50px] max-mob-lg:py-6">
      <Container>
        <div className="rounded-[20px] bg-[#222222] w-full mx-auto flex flex-row justify-between max-tab-lg:flex-wrap max-tab-lg:p-[30px]">
          <div data-aos="fade-up" className="flex flex-col justify-center 2xl:pl-[77px] px-[20px] max-tab-lg:pl-auto gap-[38px] max-tab-lg:w-full max-tab-lg:text-center max-tab-lg:items-center">
            <div>
              <h2 data-aos="fade-up" className="text-[40px] leading-[50px] text-left max-des-xl:text-center font-bold text-white max-w-[595px] max-des-3xl:text-2xl max-des-5xl:leading-normal">
                Ready to Transform Your Business with AI Workflow Automation?
              </h2>
              <p data-aos="fade-up" className="text-[18px] text-white/90 mt-4 max-w-[550px] max-mob-lg:text-base">
            ...
            <div data-aos="fade-up" className="flex flex-row gap-[20px] max-des-2xl:flex-wrap">
              <button
            ...
            <div className="bg-accent-100/20 rounded-[15px] p-4 max-w-[500px]">
              <p data-aos="fade-up" className="text-accent-100 font-bold text-[16px] mb-2">
                🚀 Free Automation Audit Included
              </p>
              <p data-aos="fade-up" className="text-white text-[14px]">
