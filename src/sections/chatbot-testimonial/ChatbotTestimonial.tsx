  ...
  return (
    <Container>
      <div className="py-[50px] max-mob-lg:py-6">
        <div className="bg-primary-100 rounded-[20px] py-[40px] px-[80px] max-mob-lg:p-[30px]">
          ...
          <p className="text-[24px] font-normal leading-[1.4] text-white/90 text-center italic mb-[40px] max-mob-lg:text-[18px]">
