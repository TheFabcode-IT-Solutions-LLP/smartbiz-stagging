...
export const metadata: Metadata = {
  ...
  description: 'Never miss another customer with 24/7 AI customer service. Instant support round-the-clock, 90% resolution rate, 70% cost savings. get started freetoday.',
