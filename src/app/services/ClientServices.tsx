    ...
    <>
      ...
      <section className=" mb-[50px] bg-primary-100">
        <div className="text-center max-w-full w-full relative max-tab-lg:pb-[50px]">
          ...
          <div data-aos="fade-up" className="absolute z-20 bottom-[60px] flex flex-col w-full max-tab-lg:mt-[50px]  max-tab-md:relative max-tab-md:bottom-0  max-tab-lg:px-4  ">
        ...
        <Container>
          ...
          <div className="grid grid-cols-2 gap-[40px] max-w-[1200px] mx-auto max-tab-lg:flex-1 max-tab-lg:flex-wrap max-tab-lg:justify-center max-tab-lg:gap-[20px]">
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="bg-[#F5F5F5] rounded-[20px] p-[40px] max-mob-lg:p-[20px]">
              <div data-aos="fade-in" data-aos-delay="100" className="text-[48px] mb-[15px]">⚙️</div>
              <h3 className="text-[24px] font-bold text-primary-100 mb-[10px] max-mob-lg:text-[18px]">
        ...
        <Container>
          <div data-aos="fade-in" className="text-center">
            ...
            <div className="grid grid-cols-2 gap-[40px] max-tab-lg:grid-cols-1">
              ...
              <div data-aos="fade-up" data-aos-delay="300" className="bg-white/20 backdrop-blur-sm rounded-[20px] p-[40px] max-mob-lg:p-[20px]">
                <div className="text-left space-y-[20px]">
                  <h3 className="text-[24px] font-bold text-white max-mob-lg:text-[18px]">
        ...
        <Container>
          <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-[30px] max-tab-lg:grid-cols-1">
              <div data-aos="fade-in" className="bg-white/10 backdrop-blur-sm rounded-[20px] p-[40px] max-mob-lg:p-[20px]">
              ...
              <div data-aos="fade-in" data-aos-delay="100" className="bg-white/10 backdrop-blur-sm rounded-[20px] p-[40px] max-mob-lg:p-[20px]">
                <p className="text-[20px] text-white italic mb-[20px] max-mob-lg:text-[16px]">
              ...
              <div data-aos="fade-in" data-aos-delay="200" className="bg-white/10 backdrop-blur-sm rounded-[20px] p-[40px] max-mob-lg:p-[20px]">
                <p className="text-[20px] text-white italic mb-[20px] max-mob-lg:text-[16px]">
      ...
      <section className="py-[50px] max-mob-lg:py-6">
        <Container>
          ...
          <div className="flex justify-between max-w-[1150px] mx-auto  max-mob-lg:gap-[30px] max-mob-lg:flex-wrap max-mob-md:flex-col">
            <div data-aos="fade-up" className=" flex-1 flex flex-col text-center items-center">
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="flex-1 flex flex-col text-center items-center">
              <div className="w-[100px] h-[100px] bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-[20px]  max-tab-sm:w-[80px] max-tab-sm:h-[80px]">
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="flex-1 flex flex-col text-center items-center">
              <div className="w-[100px] h-[100px] bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-[20px] max-tab-sm:w-[80px] max-tab-sm:h-[80px]">
            ...
            <div data-aos="fade-up" data-aos-delay="300" className="flex-1 flex flex-col text-center items-center">
              <div className="w-[100px] h-[100px] bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-[20px] max-tab-sm:w-[80px] max-tab-sm:h-[80px]">
